                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text('${property.bedroomCount ?? 0} PN', style: const TextStyle(fontSize: 11, color: Color(0xFF78736D))),
                      ],
                    ),
                    Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        ...
                        const SizedBox(width: 3),
                        Text('${property.bathroomCount ?? 0} PT', style: const TextStyle(fontSize: 11, color: Color(0xFF78736D))),
                      ],
                    ),
                    Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        ...
                        const SizedBox(width: 3),
                        Text('${property.floorCount ?? 1} Tầng', style: const TextStyle(fontSize: 11, color: Color(0xFF78736D))),
                      ],
                    ),
                    Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        ...
                        Text(
                          ...
                          style: const TextStyle(fontSize: 11, color: Color(0xFF78736D)),
                        ),
                      ],
                    ),
                  ],
